...
?>
                    ...
                    <div class="col-xs-12" id="induk-barang">
						...
						<div class="row">
                            <button id="bootbox-regular"class="btn btn-white btn-default"><span class="ui-icon ace-icon fa fa-plus center bigger-110 blue"></span> Tambah Data <?php echo $pagename; ?></button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header" style="background-color:#8F0000; color:white;">
									...
									<h4 class="modal-title" >Data <?php echo $pagename; ?></h4></div>
